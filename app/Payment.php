...
class Payment
{
    ...
    public function pay($paymentGateway, $paymentToken, $input)
    {
        ...
        return Order::create([
            ...
            'billing_address_1'    => array_get($input, 'delivery_address_1', ''),
            'billing_address_2'    => array_get($input, 'delivery_address_2', ''),
            'billing_suburb'       => array_get($input, 'delivery_suburb', ''),
            'billing_state'        => array_get($input, 'delivery_state', ''),
            'billing_postcode'     => array_get($input, 'delivery_postcode', ''),
